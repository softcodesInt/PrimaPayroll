...
import { addJobTitle, editJobTitle } from 'redux/settings/actions';
	...
	return (
		<>
			<Modal
				...
				title={isEdit ? 'Edit Job Title' : 'Add New Job Title'}
			>
...
export default connect(mapStateToProps, { addJobTitle, editJobTitle })(
	AddJobTitle
);
