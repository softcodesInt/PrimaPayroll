...
import { addJobGrade, editJobGrade } from 'redux/settings/actions';
	...
	return (
		<>
			<Modal
				...
				title={isEdit ? 'Edit Job Grade' : 'Add a New Job Grade'}
			>
						...
						>
							{({
								...
								<form onSubmit={handleSubmit}>
									...
									>
										{isEdit ? 'Save Changes' : 'Add Job Grade'}
									</Button>
								</form>
							)}
						</Formik>
...
AddJobGrade.propTypes = propTypes;
